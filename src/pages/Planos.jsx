        ...
        <div className="bg-gray-50">
            ...
            <div className="flex flex-col h-[80vh] items-center gap-8 p-4">
                ...
                <div className="flex flex-col md:flex-row gap-6 mt-6 items-start">
                    <div className="bg-white shadow-md rounded-2xl p-6 w-full md:w-[300px]  flex flex-col justify-between border border-gray-200">
                        <div>
                            <h2 className="text-2xl font-semibold text-[#022946] mb-2">Plano de divulgação</h2>
                    ...
                    <div className="bg-white shadow-xl rounded-2xl p-6 w-full md:w-[300px]  flex flex-col justify-between border border-gray-200">
                        <div>
                            <h2 className="text-2xl font-semibold text-[#022946] mb-2">Plano Sistema</h2>
                            <p className="text-gray-600 mb-4 text-sm">
